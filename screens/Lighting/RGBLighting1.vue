            ...
            <view class="innova-layout">
                ...
                <view style="flex:8; flex-direction:column">
                    ...
                    <view class="default-row-container">
                        <red-switch name="gutter_red" v-on:update-status="(event) => eventoRecibido(event) "/>

                        <Innova-Slider-Red name="gutter_red" menu="lighting"/>
                    </view>
                    
                    <view class="default-row-container">
                        <green-switch name="gutter_green" v-on:update-status="(event) => eventoRecibido(event) "/>
                        <Innova-Slider-Green name="gutter_green" menu="lighting"/>
                        
                    </view>
                    
                    <view class="default-row-container">
                        <blue-switch name="gutter_blue" v-on:update-status="(event) => eventoRecibido(event) "/>
                        <Innova-Slider-Blue name="gutter_blue" menu="lighting"/>
                    </view>
                </view>
