        ...
        <ImageBackground :source="require('./../../assets/Innova/BG/fondomain.png')"
            ...
            <view class="innova-layout">
                <view style="flex:1.5; flex-direction:column">
                    <Innova-Header/>
                    <Screen-Title screenTitle="RGB-2"/>
                </view>
                ...
                <view style="flex:8; flex-direction:column">
                    ...
                    <view class="default-row-container">
                        <red-switch name="louver_red" v-on:update-status="(event) => eventoRecibido(event) "/>

                        <Innova-Slider-Red name="louver_red" menu="lighting"/>
                    </view>
                    
                    <view class="default-row-container">
                        <green-switch name="louver_green" v-on:update-status="(event) => eventoRecibido(event) "/>
                        <Innova-Slider-Green name="louver_green" menu="lighting"/>
                        
                    </view>
                    
                    <view class="default-row-container">
                        <blue-switch name="louver_blue" v-on:update-status="(event) => eventoRecibido(event) "/>
                        <Innova-Slider-Blue name="louver_blue" menu="lighting"/>
